...
public:
	...
	template<typename ...Args> Object& allocate(Args&& ...args);
...
template <class Object>
ObjectPool<Object>::ObjectPool(size_t pool_size) : data(new uint8_t[pool_size * sizeof(Object)]),
free_object_flags(pool_size, true),
capacity(pool_size)
{
...
Object& ObjectPool<Object>::allocate(Args&& ...args)
{
...
template <class Object>
void  ObjectPool<Object>::free(Object& object)
{
...
template <class Object>
Object* ObjectPool<Object>::get_object_ptr(size_t position) noexcept
{
